...
Use image revision tags such as `wodby/nginx:1.31-rN` to select a Wodby image revision.
Major and minor tags use the repository release number, starting at `r0`. Full-version tags such as
`wodby/nginx:1.31.6-r0` start at `r0` for each exact upstream version.
...
See [release tags](https://github.com/wodby/nginx/tags) for available revisions and the [image revision policy](https://github.com/wodby/images#image-revisions) for upgrade guidance.
...
- `1.31`, `1`, `latest` [_(Dockerfile)_](https://github.com/wodby/nginx/tree/master/Dockerfile)
- `1.30` [_(Dockerfile)_](https://github.com/wodby/nginx/tree/master/Dockerfile)
