...
nginx_exec curl -I "localhost/authorize.php" | grep '302 Found'
echo -n "cron.php...        "
nginx_exec curl -I "localhost/cron.php" | grep '302 Found'
echo -n "index.php...       "
nginx_exec curl -I "localhost/index.php" | grep '302 Found'
echo -n "install.php...     "
nginx_exec curl -I "localhost/install.php" | grep '200 OK'
echo -n "update.php...      "
nginx_exec curl -I "localhost/update.php" | grep '302 Found'
echo -n "xmlrpc.php...      "
nginx_exec curl -I "localhost/xmlrpc.php" | grep '302 Found'
echo -n ".htaccess...       "
